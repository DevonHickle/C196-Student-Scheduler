...
public class AddEditTerms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editStartDate.setOnClickListener(view -> new DatePickerDialog(AddEditTerms.this,
                dateStart,
        ...
        editEndDate.setOnClickListener(view -> new DatePickerDialog(AddEditTerms.this,
                dateEnd,
